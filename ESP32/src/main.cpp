...
void sendMessage() {
  ...
  msg1 ="";
  msg1+="Temperature = ";
  msg1+=bme.temperature;
  //Serial.print(bme.temperature);
  //Serial.println(" *C");
 msg1+=" Pressure = ";
 msg1+=bme.pressure / 100.0;
 msg1+=" hPa ";
 msg1+=" Humidity = ";
 msg1+=bme.humidity;
 msg1+=" % ";
 msg1+=" Gas = ";
 msg1+=bme.gas_resistance / 1000.0;
 msg1+=" KOhms ";
  msg1+=" Approx. Altitude =  ";
 msg1+=bme.readAltitude(SEALEVELPRESSURE_HPA);
  msg1+=" m "; 
 //msg1+=" PIR= ON";
 ...
 /* if (calc_delay) {
  ...
  Serial.println("Sending message:"+ msg1);
